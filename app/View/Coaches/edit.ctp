...
<?php echo $this->Form->create('Coach'); ?>
	<fieldset>
		<legend><?php echo __('Edit Coach'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Coach.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Coach.id'))); ?></li>
